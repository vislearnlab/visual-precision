...
STIMULI_PATH = "https://[BLINDED]/stimuli/"
...
aoa_aggregated_diff <- stimuli_all |>
  ...
  pivot_longer(cols=starts_with("Word")& !matches("^wordpairing$"),
               names_to="Word_Type",
               values_to="Word") |>
...
ggsave(here("stimuli", "lookit", "preprocessing", "plots", "kupermanWordbank.png"), bg="white")
```
