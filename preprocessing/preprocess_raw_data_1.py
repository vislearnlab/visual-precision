...
def convert_webm_to_mp4(input_path, output_path, consent_path):
    ...
    for file in os.listdir(input_path):
        ...
        pattern = (
            r'^.*videoStream_'                 # Match for "*videoStream_"
            r'([a-f0-9-]{36})_'              # Group the study UUID
            r'(\d+-[a-zA-Z0-9-]+)_'          # Group the trial ID (ex: 38-easy-turkey-swan)
            r'([a-f0-9-]{36})_'              # Group the response UUID
