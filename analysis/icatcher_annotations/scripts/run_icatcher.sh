...
project_path=$1
icatcher_scripts_path="$project_path/analysis/icatcher_annotations/scripts"
output_annotations_path="$project_path/data/icatcher_annotations"
output_videos_path="$project_path/data/icatcher_videos"
