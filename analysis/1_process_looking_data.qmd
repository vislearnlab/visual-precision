...
#exploratory normalization strategies
zscore <- read_csv(here("data/embeddings/zscore_similarities.csv"))
```
...
trial_metadata <- trial_metadata |>
  ...
  left_join(zscore_sims, by=c("Trials.targetImage"="target", "Trials.distractorImage"="distractor")) |>
  rename(image_sim_zscore = image_sim, text_sim_zscore = text_sim)
```
