...
cvcl_similarities <- read.csv(here("data", "embeddings", "cvcl_similarities.csv"))
openclip_similarities <- read.csv(here("data", "embeddings", "openclip_similarities.csv"))
...
ggplot(participant_age_halves,
  ...
  labs(caption = (paste0("14-24 month olds age split at M=",mean_age)), title="Word recognition acuracy by age")

ggsave(here("figures",PROJECT_VERSION,"accuracy_age.png"),looking_times,width=9,height=6,bg = "white")
```
