...
age_continuous <- ggplot(participant_age_jittered, aes(x = x_jittered, y = mean_value)) +
  ...
  theme_minimal()
age_continuous
ggsave(here("figures",PROJECT_VERSION,"age_plot.svg"),age_continuous,width=11,height=4,bg = "white")
```
...
clip_data_long <- clip_data_summarized |>
  pivot_longer(cols = c("text_similarity", "image_similarity", "multimodal_similarity"), names_to = "sim_type", values_to = "similarity")
...
all_clip_plot
ggsave(here("figures",PROJECT_VERSION,"clip_plot.svg"),all_clip_plot,width=9,height=6,bg = "white")
```
...
looking_times_aoa
ggsave(here("figures",PROJECT_VERSION,"aoa_plot.svg"),looking_times_aoa,width=11,height=4,bg = "white")
```
